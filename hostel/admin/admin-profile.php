			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Кабинет</h2>
	<?php	
$aid=$_SESSION['id'];
						...
						<div class="row">
							<div class="col-md-6">
								<div class="panel panel-default">
									<div class="panel-heading">Данные Администратора</div>
										...
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													Невозможно изменить имя.</span> </div>
											</div>
											<div class="form-group">
...
<div class="form-group">
									...
									<input type="text" class="form-control" value="<?php echo $row->reg_date;?>" disabled >
												...
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="update" value="Обновить Данные">
												</div>
											</div>
...
<div class="form-group">
				...
				<input type="password" class="form-control" value="" required="required" id="cpassword" name="cpassword" >
												...
												<div class="col-sm-6 col-sm-offset-4">
													<button class="btn btn-default" type="submit">Назад</button>
													<input type="submit" name="changepwd" Value="Изменить пароль" class="btn btn-primary">
											</div>
