...
$rc=$stmt->bind_param('sss',$course_code,$course_sn,$course_fn);
$stmt->execute();
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Добавить специальность</h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">КУРС</div>
									<div class="panel-body">
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Название специальности</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
											<label class="col-sm-2 control-label">Название факультета</label>
											<div class="col-sm-8">
