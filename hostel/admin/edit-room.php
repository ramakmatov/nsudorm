...
$id=$_GET['id'];
$query="update rooms set seater=?,fees=?, inventors=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iisi',$seater,$fees,$inventors,$id);
$stmt->execute();
...
<head>
	...
	<title>Изменить данные о комнате</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Изменить данные о комнате</h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Изменить данные о комнате</div>
...
<div class="col-sm-8">
<input type="text" class="form-control" name="inventors" id="inventors" value="<?php echo $row->inventors;?>" required="required">
</div>
</div>
