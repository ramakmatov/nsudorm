	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:4%">Управление счетами</h2>
...
<td><?php echo $difference; ?></td> <!-- Добавлен столбец "Остаток к оплате" -->
<td><a href="edit-finance.php?id=<?php echo $row->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<!-- <a href="manage-courses.php?del=<?php echo $row->id;?>" onclick="return confirm('ВЫ точно хотите удалить?');"><i class="fa fa-close"></i></a></td> -->
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
